<x-app-layout>
    @section('title', __('Unit of Measure'))
    @section('content')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{__('Unit Of Measure')}}</li>
                </ul>
            </div>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                @can('create uom')
                    ...
                    <i class="ki-duotone ki-plus fs-2"></i>{{__('Add Unit of Measure')}}</button>
                @endcan

                @include('home.uom.create-uom')    
            </div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column flex-column-fluid">
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div id="status"></div>
                <div class="card">
                    @include('home.uom.uom-component')
                </div>
            </div>
        </div>
    </div>
