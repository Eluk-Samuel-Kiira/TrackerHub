                    ...
                    <tr data-role="{{ strtolower($department->name) }}">
                        ...
                        <td class="d-flex align-items-center gap-2 flex-column flex-sm-row">
                            ...
                            @can('delete department')
                                ...
                                data-bs-toggle="modal" 
                                    data-bs-target="#deleteUserModal{{$department->id}}">
                                    <i class="bi bi-trash me-1 fs-5"></i> <span>{{ __('Delete') }}</span>
                                </button>
                            @endcan

                            <!-- Delete User Modal -->
                            <div class="modal fade" id="deleteUserModal{{$department->id}}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <!-- Discard Button -->
                                            <button type="button" id="closeDeleteModal{{$department->id}}" class="btn btn-light me-3" data-bs-dismiss="modal">{{ __('Discard') }}</button>
                                            <!-- Confirm Button -->
                                            <button type="button" id="deleteButton{{$department->id}}" class="btn btn-danger" 
                                                data-item-url="{{ route('departments.destroy', $department->id) }}" 
                            ...
                            @include('home.department.edit-department')
