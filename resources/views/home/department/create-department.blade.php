    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_department">
                <h2 class="fw-bold">{{__('Create Requisition Category')}}</h2>
            ...
            <div class="modal-body px-5 my-7">
                <form id="kt_modal_add_department_form" class="form">
                    @csrf
                    <input type="hidden" class="form-control form-control-solid" name="department_page" value="true"/>
...
<script>
    ...
    submitFormEntities('kt_modal_add_department_form', 'submitDepartmentButton', '{{ route('departments.store') }}');
</script>
