        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                <form id="kt_modal_add_category_form" class="form">
                    @csrf
                    <input type="hidden" class="form-control form-control-solid" name="category_page" value="true"/>
                    <div class="text-center pt-10">
                        <div class="row g-9 mb-8">
                            <div class="d-flex flex-column mb-8 fv-row col-md-12">
                                ...
                                <input type="text" class="form-control form-control-solid" name="project_category_name" />
                                <div id="project_category_name"></div>
                            </div>
                        </div>
...
<script>
    ...
    submitFormEntities('kt_modal_add_category_form', 'submitCategoryButton', '{{ route('project_categories.store') }}');
</script>
