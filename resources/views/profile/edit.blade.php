    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">{{__('Profile Settings')}}</h1>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold" id="account_tabs">
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active" id="profile-tab" data-bs-toggle="tab" href="#profile">Profile Information</a>
                        </li>
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" id="password-tab" data-bs-toggle="tab" href="#update-password">Update Password</a>
                        </li>
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" id="deactivate-tab" data-bs-toggle="tab" href="#deactivate">Account Deactivation</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="tab-content mt-5" id="account_tabs_content">
                ...
                <div class="tab-pane fade" id="update-password">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title fw-bold">Update Password</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="tab-pane fade" id="deactivate">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title fw-bold">Deactivate Account</h3>
                        </div>
                        <div class="card-body">
